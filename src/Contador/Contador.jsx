...
//Una aplicación web tiene que hacer mucho más que solo mostrarse, tiene que realizar operaciones, consumir datos de servidores, usar eventos. 
...
const Contador = ({ stock, inicial }) => {
    ...
    useEffect(() => {
        ...
        */
       //Esto no es lo más recomendado porque estoy accediendo directamente al DOM. Y no se considera una buena práctica. Mejor es usar el estado para cambiar el color del botón. Hacemos lo siguiente: 
       }
